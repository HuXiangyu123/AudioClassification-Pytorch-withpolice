...
add_arg('audio_folder', str, 'dataset/second', '音频文件夹路径')  # Change to folder path
...
filefolder_pre='dataset/784预留0样本'
wavfile = []
#读取文件夹下所有wav文件名
...
# 保存结果到Excel
times='0样本'
excel_output_path = 'rawdata_(wav)'+times+'stacking_'+'prediction_results.xlsx'
